...
Install
-------
By default its code command is for Huawei Matebook X Pro (2018) with Realtek ALC256 Audio Codec with Combo Jack, you may need to change that in `fixAudio` function.
