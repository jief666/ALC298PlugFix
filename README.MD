...
Install
-------
By default it's code command is for Lenovo ThinkPad(s) with Realtek ALC257 Audio Codec with Combo Jack, you may need to change that in `fixAudio` function.
